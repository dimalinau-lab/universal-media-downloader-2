# Universal Media Downloader v2.6
...
<p align="center">
  <a href="#что-нового-в-версии-25">Что нового</a> •
...
- **Удаленное управление (Telegram-бот)**: Добавлена возможность присылать ссылки боту со смартфона — программа на ПК автоматически начнет загрузку.
...
- **Встроенная визуальная обрезка**: Возможность легко вырезать нужный фрагмент из скачанного видео прямо в приложении.
...
- **Темы**: Полная поддержка тёмной и светлой темы интерфейса с плавными эффектами наведения.
