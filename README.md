# Universal Media Downloader v2.1
...
<p align="center">
  <a href="#что-нового-в-версии-21">Что нового</a> •
...
## ✨ Что нового в версии 2.1 (плейлисты и Масштабное обновление)

- 📋 **Работа с плейлистами:** Добавлено красивое всплывающее окно для выбора конкретных видео из плейлиста. Больше не нужно скачивать весь сезон целиком — просто отметьте нужные серии галочками (встроен удобный поиск по названиям (youtube))!
