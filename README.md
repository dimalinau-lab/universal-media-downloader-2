# Universal Media Downloader v2.0
...
<p align="center">
  <a href="#что-нового-в-версии-20">Что нового</a> •
...
## ✨ Что нового в версии 2.0 (Масштабное обновление)

- 🎨 **Полный редизайн (Fluent Design):** Интерфейс приложения был переписан с нуля в современном стиле Windows 11 с использованием библиотеки `qfluentwidgets`. Добавлены плавные анимации, новые иконки, закругленные края и прозрачные элементы.
- 📂 **Встроенный файловый менеджер:** Появилась новая вкладка **«Файлы»**. Теперь просматривать скачанные видео можно прямо в программе. Файлы отображаются в виде красивых карточек с указанием размера и кнопками быстрого действия (воспроизвести, открыть папку, удалить).
- 🖼️ **Автоматические превью:** Во вкладке файлов программа сама незаметно (в фоновом режиме через FFmpeg) вытаскивает кадр из каждого скачанного видео и создает для него красивую обложку-превью.
---
...
- **Cookies**: авторизация через файл или браузер (Chrome, Opera, Edge, Firefox и др.)
